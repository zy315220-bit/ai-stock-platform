...
class LiquidityForecastRequest(BaseModel):
    ...
    current_cash: float = Field(ge=0, le=10_000_000_000)
    safety_cash_floor: float = Field(ge=0, le=10_000_000_000)
    baseline_daily_inflow: float = Field(ge=0, le=1_000_000_000)
    daily_inflow_volatility: float = Field(ge=0, le=1_000_000_000)
    fixed_daily_outflow: float = Field(ge=0, le=1_000_000_000)
    payroll_amount: float = Field(ge=0, le=10_000_000_000)
    ...
    simulations: int = Field(default=5000, ge=500, le=20_000)
