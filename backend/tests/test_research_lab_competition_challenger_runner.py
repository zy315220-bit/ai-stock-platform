...
from app.services.research_lab.competition_challenger_runner import (
    ...
    run_challenger_tournament_on_frames,
)
...
def test_empty_roster_waits_without_downloading_or_competing() -> None:
    ...
    result = run_challenger_tournament_on_frames({}, roster)
...
def test_certified_challenger_enters_same_forward_ranking_as_incumbents() -> None:
    frames = {
    ...
    result = run_challenger_tournament_on_frames(
        frames,
        roster,
